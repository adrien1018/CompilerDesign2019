...
* Allow long distance jumps in branch instructions (GCC and Clang both fail on the testcase generated by `testcase/gen-large-if.cpp`)
* Register lifetime analysis
* Register frequency analysis: pseudo registers that appear more frequently have higher priorities to be placed in the real registers.
